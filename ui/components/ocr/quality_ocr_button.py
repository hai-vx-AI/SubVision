...
class QualityOCRButton(QPushButton):
    """
    Independent visual component for Quality OCR selection.

    Exclusivity with FastOCRButton is handled outside this component.
    """
    ...
    def _build_ui(self) -> None:
        ...
        self.setText("Quality OCR")
        self.setObjectName("qualityOCRButton")
