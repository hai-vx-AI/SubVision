...
class DashboardButton(QPushButton):
    """
    Independent visual component for the Dashboard feature.

    Dashboard is a top-level feature, not a Dictionary output mode.
    This component does not open/close the Dashboard window and does not
    know backend DashboardEntry objects.
    """
