...
class LanguageModelButton(QPushButton):
    """
    Independent visual component for the Language Model feature.

    Mutual exclusion with Dictionary is NOT handled here.
    An external coordinator/controller must decide the application state
    and then call set_selected() on the relevant buttons.
    """
    ...
    def _build_ui(self) -> None:
        ...
        self.setText("Language Model")
        self.setObjectName("languageModelButton")
