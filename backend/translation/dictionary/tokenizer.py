...
class TokenizerConfig:
    ...
    include_single_character_words: (
        bool
    ) = True
...
class DictionaryTokenizer:
    ...
    #
    # Mục tiêu ở đây không phải validate email theo toàn bộ RFC.
    # Chỉ cần nhận diện email thường xuất hiện trong OCR/screen text
    # để không bị tokenizer tách thành nhiều word.
    EMAIL_PATTERN = (
        r"[A-Za-z0-9._%+\-]+"
        r"@"
        r"[A-Za-z0-9.\-]+"
